...
| [`design/`](design/)          | Deep design for a subsystem, usually written **before or alongside** the code: app-data, approvals, fetch-proxy, secrets & connections, dev-mode, git connections, custom backends. | Forward-looking               |
