...
**Purpose:** Design third-party HTTP access through the gateway. Support both
apps written for Helix and existing apps that already use fetch or XHR. The
optional shim should let those existing calls use approved proxy routes with
