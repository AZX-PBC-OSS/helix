...
1. **Now (cheap):** add a `jti` one-time-use burn (bounded seen-set / table at egress) and `aud: "azx-egress"`, asserted in `jwtVerify`. Closes replay and token-passthrough (ISSUE-04). **✅ Done 2026-07-21 — see Resolution below.**
...
## Resolution — Step 1 (2026-07-21, issue #3)
