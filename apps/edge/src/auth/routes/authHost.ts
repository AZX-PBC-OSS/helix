...
export function makeStartHandler(rt: AuthHostRuntime) {
  return async function handleStart(req: FastifyRequest, reply: FastifyReply): Promise<void> {
...
export function makeCallbackHandler(rt: AuthHostRuntime) {
  return async function handleCallback(req: FastifyRequest, reply: FastifyReply): Promise<void> {
